        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col items-center text-center">
            ...
            <div className="flex gap-2">
              <span className="px-3 py-1 bg-primary/10 text-primary text-xs font-bold rounded-full uppercase">Student</span>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800">
            ...
            <div className="space-y-3">
              {[
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-3 rounded-xl border-2 transition-all ${colorTheme === t.id
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
              ...
              <button
                ...
                className={`w-12 h-6 flex items-center rounded-full p-1 transition-colors duration-300 ${theme === "dark" ? "bg-primary" : "bg-gray-300 dark:bg-gray-700"
                  }`}
              >
                <div
                  className={`bg-white w-4 h-4 rounded-full shadow-md transition-transform duration-300 ${theme === "dark" ? "translate-x-6" : ""
                    }`}
                />
              </button>
            </div>
